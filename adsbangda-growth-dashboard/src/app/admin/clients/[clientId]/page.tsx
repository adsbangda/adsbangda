  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="space-y-8 p-5 lg:p-8">
        <div>
          <p className="font-data text-[11px] uppercase tracking-wider text-muted">Client</p>
          <h1 className="mt-1 font-display text-2xl font-bold tracking-tight text-ink">{client.name}</h1>
