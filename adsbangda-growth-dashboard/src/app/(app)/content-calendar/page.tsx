  ...
  return (
    <div className="page-backdrop min-h-screen">
      ...
      <div className="mx-auto max-w-5xl px-5 py-8 lg:px-8 lg:py-10">
        {waitingCount > 0 && (
          <div className="mb-6 rounded-[var(--radius-lg)] border border-warning-soft bg-warning-soft/50 px-5 py-3.5 text-sm text-ink">
              ...
              {items.map((item) => {
                ...
                return (
                  <tr key={item.id} className="border-b border-border last:border-0">
                    ...
                    <td className="px-5 py-3.5 capitalize text-muted">{item.type}</td>
