  ...
  return (
    <Card padding="lg" className="flex h-full flex-col">
      ...
      <div className="mt-5 flex items-stretch gap-5">
        <CylinderProgress value={overallPct} width={68} height={130} />
        <div className="flex flex-col justify-center">
          ...
          <span className="mt-2.5 inline-flex w-fit items-center gap-1.5 rounded-full bg-accent-soft px-2.5 py-1 font-data text-[11px] font-semibold text-accent">
